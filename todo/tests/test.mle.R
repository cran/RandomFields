...
## Ofitvario muss ungeschrieben werden so dass
## fitvario und die .so Datei von RandomFields V.1.X
## verwendet wird. Dafuer gibt es unter R bestimmte Aufrufe.
## Oder aber man speichert die Daten raus und ruft nochmals auf.
